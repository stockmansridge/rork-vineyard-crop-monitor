...
export type { ShareRole, Capability } from '@/lib/permissions';
export { roleHas, roleLabel, ROLE_CAPABILITIES } from '@/lib/permissions';
import type { ShareRole, Capability } from '@/lib/permissions';
